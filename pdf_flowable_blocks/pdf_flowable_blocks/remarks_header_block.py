...
class RemarksHeaderBlock:
    ...
    def _create_stylesheet(self) -> StyleSheet1:
        ...
        stylesheet.add(
            ParagraphStyle(
                "header",
                fontName=RemarksHeaderBlockStyles.Header.FONT,
                fontSize=RemarksHeaderBlockStyles.Header.SIZE,
                textColor=RemarksHeaderBlockStyles.Header.COLOR,
                leading=RemarksHeaderBlockStyles.Header.SIZE * PDFLineSpacing.SINGLE,
                alignment=TA_CENTER,
        ...
        stylesheet.add(
            ParagraphStyle(
                "subheader",
                fontName=RemarksHeaderBlockStyles.SubHeader.FONT,
                fontSize=RemarksHeaderBlockStyles.SubHeader.SIZE,
                textColor=RemarksHeaderBlockStyles.SubHeader.COLOR,
                leading=RemarksHeaderBlockStyles.SubHeader.SIZE * PDFLineSpacing.SINGLE,
                alignment=TA_CENTER,
        ...
        stylesheet.add(
            ParagraphStyle(
                "subsubheader",
                fontName=RemarksHeaderBlockStyles.SubSubHeader.FONT,
                fontSize=RemarksHeaderBlockStyles.SubSubHeader.SIZE,
                textColor=RemarksHeaderBlockStyles.SubSubHeader.COLOR,
                leading=RemarksHeaderBlockStyles.SubSubHeader.SIZE * PDFLineSpacing.SINGLE,
                alignment=TA_CENTER,
                # spaceBefore=PDFTextStyles.Header.SPACE_BEFORE,
                # spaceAfter=PDFTextStyles.Header.SPACE_AFTER,
            )
        ...
        stylesheet.add(
            ParagraphStyle(
                "right_block",
                fontName=RemarksHeaderBlockStyles.RightBlock.FONT,
                fontSize=RemarksHeaderBlockStyles.RightBlock.SIZE,
                textColor=RemarksHeaderBlockStyles.RightBlock.COLOR,
                leading=RemarksHeaderBlockStyles.RightBlock.SIZE * PDFLineSpacing.SINGLE,
                alignment=TA_CENTER,
    ...
    def create_remarks_header_flowables(
        self,
